...
author: "Stuart Lee and Nick Tierney"
...
* `r emo::ji("heart")`: board games, cooking, music, reading and video games
]

.pull-right[
```{r img-stu, out.width = "80%"}
include_graphics("images/stuart.jpeg")
```
...
1. Find your name from the list at [this link](https://mida.numbat.space/groups.html)
2. Find the other people in the class with the same gorup name as you (feel free to wander around the class!)
...
.pull-right[
```{r plot-genes-out, ref.label = 'plot-genes', echo = FALSE, out.height = "100%"}
```
