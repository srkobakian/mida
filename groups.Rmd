...
sheets <- "https://docs.google.com/spreadsheets/d/1C9RZRbD5sCzT6c4OhELdyTaBPCgtKQzX66CuFzUvUxg/edit?usp=sharing"
```
...
write_csv(students, here::here("etc1010-groups.csv"))
```

```{r display-groups, echo = FALSE}
read_csv(here::here("etc1010-groups.csv")) %>% 
